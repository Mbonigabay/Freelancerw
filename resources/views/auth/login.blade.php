        ...
        <div class="container mt--8 pt-5">
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-7">
                    <div class="card shadow border-0" style="background-color: white; color: #3333ff">
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" style="background-color: white; color: #3333ff"><i class='fas fa-envelope'></i> </span>
                                        </div>
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" style="background-color: white; color: #3333ff"><i class="fas fa-lock"></i> </span>
                                    </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="text-center">
                                        <button type="submit"
                                                onMouseOver="this.style.backgroundColor='#3333ff'; this.style.color='white'"
                                                onMouseOut="this.style.backgroundColor='white'; this.style.color='#3333ff'"
                                                class="btn"
                                                name="Login"
                                                style="background-color: white; color: #3333ff;border-radius: 1px; border-color: #3333ff;">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-6 text-right">
                            <a href="{{ route('register') }}" class="btn btn-link text-light"><small>Create new account</small></a>
                        </div>
                    </div>
                </div>
            </div>
