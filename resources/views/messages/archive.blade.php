                    ...
                    <div class="card shadow border-0">
                        ...
                        <div class="card-body" style="color: darkblue">
                            ...
                            <ul id="dtBasicExample" class="list-group list-group-flush">
                                ...
                                <h3>Archived Messages ({{ \App\Message::where('user_from', Auth::user()->id)->orWhere('user_to', Auth::user()->id)->where('status', 'archived')->count() }}
                                    )</h3>
                        ...
                        <div class="card shadow border-0">
                            ...
                            <div class="card-body" style="color: darkblue">
                                ...
                                <ol class="list-unstyled" >
                                    <li ><a href="{{action('MessageController@compose')}}" style="color: darkblue"><i class="fa fa-btn fa-plus-circle"></i> Compose a message</a></li>
